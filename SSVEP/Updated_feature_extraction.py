...
# =============================================================================
def extract_features_for_S8(directory, fs, window_size=2, overlap=0.5):
    """
    Extract features for subject S_8 from segmented BrainVision files.
    ...
    for subject_folder in subject_folders:
        ...
        for run_folder in run_folders:
            ...
            stimulus_folder = preprocessed_path / f"{subject_code}_Stimulus"
            pattern = f"{subject_code}_S__8_seg_*_raw.vhdr"
            ...
            if not eeg_files:
                logger.warning("No segmented BrainVision files found for %s in %s", subject_code, stimulus_folder)
                continue
...
# =============================================================================
def save_features_by_class(feature_matrices, filename='eeg_features_S8.h5'):
    """
...
def main():
    ...
    feature_matrices = extract_features_for_S8(directory, fs, window_size, overlap)
    ...
    filename_out = "chetan_subject_eeg_features_S8_hierarchical.h5"
