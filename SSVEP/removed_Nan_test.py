...
def main():
    raw_hdf5 = "No_ICA_subject_eeg_features_S6_hierarchical.h5"      # Raw features file
    output_hdf5 = "Removed_NAN_No_ICA_SUBJECT_eeg_features_S6_normalized.h5"  # Output file
